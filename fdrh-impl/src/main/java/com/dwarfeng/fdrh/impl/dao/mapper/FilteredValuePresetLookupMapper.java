...
@Component
public class FilteredValuePresetLookupMapper implements PresetLookupMapper {
    ...
    private Object[] general2Args(String preset, Object[] args) {
        switch (preset) {
            ...
            case FilteredValueMaintainService.CHILD_FOR_FILTER:
                return childForFilter(preset, args);
            case FilteredValueMaintainService.CHILD_FOR_FILTER_SET:
                return childForFilterSet(preset, args);
            ...
            case FilteredValueMaintainService.CHILD_FOR_FILTER_BETWEEN:
                return childForFilterSetBetween(preset, args);
            default:
    ...
    @SuppressWarnings("unused")
    private Object[] childForFilter(String preset, Object[] args) {
        LongIdKey key = (LongIdKey) args[0];
        if (Objects.isNull(key)) {
            return new Object[0];
        } else {
    ...
    private Object[] childForFilterSet(String preset, Object[] args) {
    ...
    @SuppressWarnings({"unused", "DuplicatedCode"})
    private Object[] childForFilterSetBetween(String preset, Object[] args) {
        LongIdKey key = (LongIdKey) args[0];
        Date date1 = (Date) args[1];
        Date date2 = (Date) args[2];
        if (Objects.isNull(key)) {
