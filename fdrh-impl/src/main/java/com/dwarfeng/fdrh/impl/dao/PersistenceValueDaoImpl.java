...
public class PersistenceValueDaoImpl implements PersistenceValueDao {
    ...
    @BehaviorAnalyse
    @SkipRecord
    public List<LongIdKey> batchInsert(@SkipRecord List<PersistenceValue> entities) throws DaoException {
        return batchBaseDao.batchInsert(entities);
    }

    @Override
    @BehaviorAnalyse
    public void batchUpdate(@SkipRecord List<PersistenceValue> entities) throws DaoException {
    ...
    @Override
    @BehaviorAnalyse
    public void batchWrite(@SkipRecord List<PersistenceValue> entities) throws DaoException {
